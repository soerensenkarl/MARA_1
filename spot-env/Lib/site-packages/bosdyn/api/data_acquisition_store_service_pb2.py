...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'B DataAcquisitionStoreServiceProtoZ)bosdyn/api/data_acquisition_store_service'

...
class AudioVisualServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddOrModifyBehavior = channel.unary_unary(
                '/bosdyn.api.AudioVisualService/AddOrModifyBehavior',
                request_serializer=bosdyn_dot_api_dot_audio__visual__pb2.AddOrModifyBehaviorRequest.SerializeToString,
                response_deserializer=bosdyn_dot_api_dot_audio__visual__pb2.AddOrModifyBehaviorResponse.FromString,
                )
        self.DeleteBehaviors = channel.unary_unary(
                '/bosdyn.api.AudioVisualService/DeleteBehaviors',
                request_serializer=bosdyn_dot_api_dot_audio__visual__pb2.DeleteBehaviorsRequest.SerializeToString,
                response_deserializer=bosdyn_dot_api_dot_audio__visual__pb2.DeleteBehaviorsResponse.FromString,
                )
...
class AudioVisualServiceServicer(object):
    ...
    def AddOrModifyBehavior(self, request, context):
    ...
    def DeleteBehaviors(self, request, context):
...
def add_AudioVisualServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AddOrModifyBehavior': grpc.unary_unary_rpc_method_handler(
                    servicer.AddOrModifyBehavior,
                    request_deserializer=bosdyn_dot_api_dot_audio__visual__pb2.AddOrModifyBehaviorRequest.FromString,
                    response_serializer=bosdyn_dot_api_dot_audio__visual__pb2.AddOrModifyBehaviorResponse.SerializeToString,
            ),
            'DeleteBehaviors': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteBehaviors,
                    request_deserializer=bosdyn_dot_api_dot_audio__visual__pb2.DeleteBehaviorsRequest.FromString,
                    response_serializer=bosdyn_dot_api_dot_audio__visual__pb2.DeleteBehaviorsResponse.SerializeToString,
            ),
...
class AudioVisualService(object):
    ...
    @staticmethod
    def AddOrModifyBehavior(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bosdyn.api.AudioVisualService/AddOrModifyBehavior',
            bosdyn_dot_api_dot_audio__visual__pb2.AddOrModifyBehaviorRequest.SerializeToString,
            bosdyn_dot_api_dot_audio__visual__pb2.AddOrModifyBehaviorResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def DeleteBehaviors(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bosdyn.api.AudioVisualService/DeleteBehaviors',
            bosdyn_dot_api_dot_audio__visual__pb2.DeleteBehaviorsRequest.SerializeToString,
            bosdyn_dot_api_dot_audio__visual__pb2.DeleteBehaviorsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'B\033DataAcquisitionServiceProtoZ#bosdyn/api/data_acquisition_service'

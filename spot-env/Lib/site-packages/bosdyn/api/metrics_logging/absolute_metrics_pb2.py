...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'B\024AbsoluteMetricsProtoZ+bosdyn/api/metrics_logging/absolute_metrics'

...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'B\030ChoreographyServiceProtoZ$bosdyn/api/spot/choreography_service'
  _CHOREOGRAPHYSERVICE._serialized_start=109
  _CHOREOGRAPHYSERVICE._serialized_end=2301

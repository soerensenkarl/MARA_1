...
# --- replace this whole function in place_brick.py ---
...
def run(robot, target: Tuple[float, float, float], *, yaw_deg: float = 0.0):
    ...
    print(f"Locked on {fid_name} in {frame_for_arm_cmds}. Starting arm sequence (yaw={yaw_deg:.1f}°).")
